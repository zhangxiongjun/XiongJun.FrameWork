...
namespace XiongJun.Core.Infrastructure
{
    public class Engine : IEngine
    {
        ...
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(Config nopConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
