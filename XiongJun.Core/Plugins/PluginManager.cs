...
using XiongJun.Core.ComponentModel;
...
namespace XiongJun.Core.Plugins
{
    public class PluginManager
    {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug, ApplicationPartManager applicationPartManager, Config config)
        {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains("4.0", StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        public static void SavePluginDescriptor(PluginDescriptor pluginDescriptor)
        {
            ...
            if (pluginDescriptor.OriginalAssemblyFile.Directory == null) return;
        ...
        public static bool DeletePlugin(PluginDescriptor pluginDescriptor)
        {
            ...
            if (pluginDescriptor.OriginalAssemblyFile.Directory != null && pluginDescriptor.OriginalAssemblyFile.Directory.Exists)
